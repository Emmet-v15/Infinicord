...
VesktopLogger.log(`Infinibop v${VesktopNative.app.getVersion()}`);

const { customEntries, customSections } = Vencord.Plugins.plugins.Settings as any as typeof SettingsPlugin;

customEntries.push({
    key: "equicord_infinibop_settings",
    title: "Infinibop Settings",
    Component: SettingsUi,
    Icon: VesktopSettingsIcon
});

customSections.push(() => ({
    section: "InfinibopSettings",
    label: "Infinibop Settings",
    element: SettingsUi,
    className: "vc-infinibop-settings"
}));
