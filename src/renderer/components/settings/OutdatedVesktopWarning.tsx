...
import { Button, Card, HeadingTertiary, Paragraph } from "@infinicord/types/components";
import { useAwaiter } from "@infinicord/types/utils";
...
export function OutdatedVesktopWarning() {
    ...
    return (
        <Card variant="warning" className={cl("updater-card")}>
            <HeadingTertiary>Your Infinicord is outdated!</HeadingTertiary>
